...
The fastest way to work through this guide is to clone the https://github.com/openliberty/draft-guide-{projectid}.git[Git repository^] and use the projects that are provided inside:
