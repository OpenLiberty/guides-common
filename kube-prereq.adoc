...
Please note that while Minikube is also available on Mac and Windows, for the purposes of this guide use Docker Desktop on Mac and Windows. For Linux use Minikube. This is because Docker Desktop provides a simplified setup process.
