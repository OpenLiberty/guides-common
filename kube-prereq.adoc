...
First, you will need containerization software for building containers. {kube} supports a variety
...
For Minikube installation instructions, see the https://github.com/kubernetes/minikube#installation[minikube installation instructions]. Read the https://github.com/kubernetes/minikube#requirements[Requirements] section as different operating systems require different prerequisites to get Minikube running.
****
