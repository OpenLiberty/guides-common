...
You will use the Docker Desktop, where a local {kube} environment is pre-installed and enabled. If you do not see the Kubernetes then you have an older version of Docker Desktop, upgrade to the latest version.
